...
GetIncome <- function(mapping_data = smkfreediv::localauthorities,
  ...
  setnames(income_final, names(income_final), c("LAcode","LAname","pop_2019","income","income_sim_mean","income_sim_sd"))
