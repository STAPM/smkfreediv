...
The second function is applied to the cleaned data to adjust expenditures for inflation using the tobacco component of the Consumer Price Index (CPI) so all values are expressed in December 2018 prices.
